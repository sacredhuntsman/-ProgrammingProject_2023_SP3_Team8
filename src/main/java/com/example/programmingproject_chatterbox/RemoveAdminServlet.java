...
@WebServlet(name = "RemoveAdminServlet", urlPatterns = { "/remove-admin" })
public class RemoveAdminServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (type.equals("group")){
            ...
            success = database.removeGroupAdmin(groupId, userId);
        }else{
            ...
            // Your business logic to make the user an admin
            Database database = new Database();
            success = database.removeChannelAdmin(channelId, userId);
